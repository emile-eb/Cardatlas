...
const META_EVENT_MAP: Record<AnalyticsEventName, string> = {
  ...
  [ANALYTICS_EVENTS.marketPulseRefreshStarted]: "market_pulse_refresh_started",
  [ANALYTICS_EVENTS.marketPulseRefreshCompleted]: "market_pulse_refresh_completed",
  [ANALYTICS_EVENTS.marketPulseRefreshFailed]: "market_pulse_refresh_failed",
  [ANALYTICS_EVENTS.marketPulseItemCount]: "market_pulse_item_count",
