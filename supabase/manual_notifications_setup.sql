-- CardAtlas notifications manual setup
-- Run this file in the Supabase SQL editor if you want to apply the
-- notifications schema changes manually instead of using `supabase db push`.
